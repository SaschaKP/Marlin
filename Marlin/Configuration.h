...
#define STRING_CONFIG_H_AUTHOR "SaschaKP" // Who made the changes.
...
//#define HOTEND_OFFSET_X { -35.0 } // (mm) relative X-offset for each nozzle
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 21.21f }//16.7f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.0957f }//0.22f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.1256f }//0.068f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1604f }//0.097f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 94.139704, 94.139704, 400.0, 147.773 }//extruder was at 140 before mod at 147.773 - 147.773 is what bondtech say it should be with the direct drive system
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 125, 125, 15, 40 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 150, 150, 30, 80 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 800, 800, 100, 1600 }

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 1600, 1600, 200, 3200 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42.00, 8.00, -0.45 }
...
#define Z_PROBE_OFFSET_RANGE_MAX 0  // (mm) <- 0 is insane, since a fixed mounted probe must always be lower than the nozzle!
...
#define X_MIN_POS_SAFE -15
#define X_MIN_POS -35
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 35
#define Y_MAX_POS Y_BED_SIZE
#define Z_MAX_POS 156
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define PREHEAT_6_LABEL       "PVB"
#define PREHEAT_6_TEMP_HOTEND 215
#define PREHEAT_6_TEMP_BED    75
