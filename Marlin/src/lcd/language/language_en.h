...
namespace LanguageNarrow_en {
  ...
  LSTR MSG_UBL_LEVEL_BED                  = _UxGT("Unified Bed Level");
  ...
  LSTR MSG_UBL_MANUAL_MESH                = _UxGT("Manual Build Mesh");
  LSTR MSG_UBL_MESH_WIZARD                = _UxGT("UBL Mesh Wizard");
  LSTR MSG_UBL_BC_INSERT                  = _UxGT("Shim & Measure");
  LSTR MSG_UBL_BC_INSERT2                 = _UxGT("Measure");
  LSTR MSG_UBL_BC_REMOVE                  = _UxGT("Remove & Measure");
  ...
  LSTR MSG_UBL_MESH_HEIGHT_ADJUST         = _UxGT("Adj Mesh Height");
